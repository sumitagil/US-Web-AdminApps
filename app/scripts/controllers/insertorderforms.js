...
app.controller('insertOrderFormsCtrl', function ($scope,$location, $http) {
            ...
            $scope.addSubmit = function() {
                   ...
                   if($scope.AdditionalInfo!=undefined && $scope.OfferInfo!=undefined){
                    ...
                    var url = "http://beta.iservices.earlymoments.com/insertorderformdetails?token="+token+"&EntryId="+$scope.EntryId+"&AdditionalInfo="+$scope.AdditionalInfo+"&OfferInfo="+$scope.OfferInfo+"&BonusInfo="+$scope.BonusInfo+"&BonusText="+$scope.BonusText+"&BonusRebuttalInfo="+$scope.BonusRebuttalInfo+"&TacInfo="+$scope.TacInfo+"&OfferRebuttal1="+$scope.OfferRebuttal1+"&OfferRebuttal2="+$scope.OfferRebuttal2+"&ShortNotes="+$scope.ShortNotes+"&callback=JSON_CALLBACK";
